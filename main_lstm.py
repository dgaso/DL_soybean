...
import glob
from src.lstm import LSTM, LSTMModel
...
data_dir='byYear'  #    byfieldID,  byYear 
y = 'out2020'  #    byfieldID,  out2022  
inputs = 'RS'
fold = '_fold4'
results = 'years' #  byfieldID  years  
predname = f'{y}_{inputs}_LSTM'

#########################
#### data parameters ####
#########################
parser.add_argument("--dump_path", type=str, default=f"./exp_{results}/{y}_{inputs}_LSTM",
...
def main(hs,bl,nl,op,so):
    ...
    # build model
    model = LSTM(c_in = data_train.shape[1], 
